...
main(void)
{
	...
	arm_matrix_instance_f32 AT;		/* Matrix A Instance */ 
    arm_mat_init_f32(&A, 4, 1, (float32_t *)A_f32);
    arm_mat_init_f32(&AT, 1, 4, AT_f32);
	arm_status status = arm_mat_trans_f32(&A,&AT);
    //
